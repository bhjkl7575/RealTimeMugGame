...
if _near {
	...
	if _nearest && scan_cool_time = 0 {
		scan_cool_time = 30;
		var dir = (point_direction(x, y, _nearest.x, _nearest.y)) div 30;
		
		if !targeted {
			global.env_text += "무언가가 매우 가까이에 있다. " + string(12 - dir) + " 방향이다.\n";
		} else {
			global.env_text += "당신은 추격받고 있다! " + string(12 - dir) + " 방향이다!\n";
		}
